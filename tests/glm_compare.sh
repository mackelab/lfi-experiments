...
COMMON1='--samples 500 --rep 15 --iw-loss --prior-alpha 0.05 --svi --sim-kwargs seed_obs=1,seed_input=42'
# COMMON2='--samples 500 --rep 15 --rnn 2 --iw-loss --prior-alpha 0.05 --svi --sim-kwargs seed_obs=1,seed_input=42 --train-kwargs observe='lasagne_out''
