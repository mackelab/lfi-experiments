...
class TextElement(FigureElement):
    ...
    def __init__(self, x, y, text, size=8, font="Arial",
...
class SVGFigure(object):
    ...
    """
    def __init__(self, width=None, height=None, width_vb=None, height_vb=None, unit='', unit_vb=''):
        ...
        self._height = height
        self._unit = unit
        self._width_vb = width_vb
        self._height_vb = height_vb
        self._unit_vb = unit_vb
    ...
    def set_viewbox(self):
        self.root.set("viewbox", "0 0 {w}{u} {h}{u}".format(w=self._width_vb, h=self._height_vb, u=self._unit_vb))
    ...
    def width(self, value):
        self.root.set('width', str(value) + self.unit)
    ...
    def height(self, value):
        self.root.set('height', str(value) + self.unit)
