...
p = dd.Uniform(lower=[0.3 * true_param for true_param in true_params],
               upper=[1.8 * true_param for true_param in true_params], seed=seed)
...
# set up inference
res = infer.SNPE(g, obs=stats_obs, n_components=1, prior_norm=True, svi=svi, pilot_samples=n_pilot_samples, seed=seed)
